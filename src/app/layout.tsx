...
export const metadata: Metadata = {
  title: {
    default: "Infusion Studio",
    template: "%s | Infusion Studio",
  },
  description:
    "Craft, blend, and brew the perfect infusions. Manage your ingredient inventory, create custom blends, and track your recipes.",
  applicationName: "Infusion Studio",
  appleWebApp: {
    capable: true,
    statusBarStyle: "default",
    title: "Infusion Studio",
  },
